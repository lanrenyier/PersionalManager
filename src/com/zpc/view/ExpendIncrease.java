...
public class ExpendIncrease extends JFrame{
	...
	public ExpendIncrease() {
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					new Increase<Object>().	ExpendIncrease(textField.getText(),textField_1.getText(),textField_2.getText(),textField_3.getText());
					updateDate();
				} catch (Exception e1) {
					// TODO 自动生成的 catch 块
					e1.printStackTrace();
